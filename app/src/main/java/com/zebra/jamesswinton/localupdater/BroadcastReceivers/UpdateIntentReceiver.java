...
public class UpdateIntentReceiver extends BroadcastReceiver {

    // Debugging
    private static final String TAG = "IntentReceiver";

    // Constants
    private static final String TOTAL_PACKAGES = "total-packages";
    private static final String PACKAGE_NAME = "package";

    @Override
    public void onReceive(Context context, Intent intent) {
        Log.i(TAG, "Update Intent Received - Starting Update");
        ...
        if (intent.getExtras() != null) {
            ...
            if (intent.getExtras().size() == 1) {
                ...
                MainActivity.startUpdateFromIntent(context, updatePackageName, UpdateType.UPGRADE);
            } else {
                ...
                MainActivity.startUplUpdateFromIntent(context, updatePackageNames, UpdateType.UPGRADE);
            }
        }
    }
}
